        ...
        <aside>
            <div className="toggle">
                <div className="logo">
                    ...
                    <h2>Admin <span className='success'>Page</span></h2>
                </div>
            ...
            <div className="menu">
                ...
                <Link to={"/about"} onClick={() => handleLinkClick(1)} className={activeLink === 1 ? 'active' : ''}>
                    <span class="material-symbols-outlined">
                        person
                    </span>
                    <h3>About</h3>
                ...
                <Link to={"/logout"} onClick={() => handleLinkClick(0)} className={activeLink === 0 ? '' : ''}>
                    <span class="material-symbols-outlined">
                        logout
                    </span>
                    <h3>Logout</h3>
